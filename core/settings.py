...
SECRET_KEY = "django-insecure-yjf#46f&y@84f8+mp1ekaa-)e*q!oc9(8z^6e_v$&dg_mv+m8k"
...
INSTALLED_APPS = [
    ...
    "qr_app",  # Custom app for QR code generation
...
#     "http://localhost:5500",
#     "http://127.0.0.1:5500",  # optional if you're using this too
# ]
